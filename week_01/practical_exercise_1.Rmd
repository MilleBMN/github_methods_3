...
```
The quadratic model is better according to both AIC and residual standard error.

    iii. in your own words, why might it be good to penalise a model like the quadratic model, we just fitted.
Well, I feel like this is a trap... Maybe it's something as simple as the fact that we don't have a lot of data points "in the ends" of the grpah, where we see the effect of adding the quadratic term? Otherwise, please do explain :))) 
